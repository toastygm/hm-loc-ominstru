...
template.url = "https://github.com/toastygm/hm-loc-ominstru";
template.bugs = "https://github.com/toastygm/hm-loc-ominstru/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-ominstru/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-ominstru/releases/download/v${pkg.version}/module.zip`;
